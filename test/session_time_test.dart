...
import 'package:sporve_app/core/utils/session_time.dart';
...
void main() {
  group('parseSessionStart preserves the calendar day', () {
    test(
      'UTC-midnight date + PM time keeps the same day (the exact bug case)',
      () {
    ...
    test('12 AM / 12 PM edge cases', () {
      final am = parseSessionStart({
        'startDate': '2026-06-20T00:00:00.000Z',
        'startTime': '12:00 AM',
      });
      final pm = parseSessionStart({
        'startDate': '2026-06-20T00:00:00.000Z',
        'startTime': '12:00 PM',
      });
      expect(am?.hour, 0);
    ...
    test('missing startTime is explicit instead of guessed', () {
      final dt = parseSessionStart({'startDate': '2026-06-20T00:00:00.000Z'});
      expect(dt, isNull);
      expect(formatTime12h(dt), 'Time unavailable');
    });

    test('malformed time is explicit instead of guessed', () {
      final dt = parseSessionStart({
        'startDate': '2026-06-20T00:00:00.000Z',
        'startTime': 'whenever',
      });
