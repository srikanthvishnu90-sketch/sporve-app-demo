...
void main() {
  ...
  group('Day 04 Pre-Launch Checklist Verification', () {
    ...
    group('Item 0.1 & 0.2: Thin-supply & Waitlist capture signal storage', () {
      test(
        'Unserved area waitlist capture saves demand signal to GetStorage',
        () async {
          final box = GetStorage();
    ...
    group('Item 0.3: Per-sport safety gating across full catalog', () {
      ...
      test(
        'Young child (age 7) is strictly blocked from high-intensity in high-risk sports',
        () {
          ...
          expect(
            ...
            reason:
                'High intensity boxing for 7-year-old must be blocked by safety gating',
          );
          ...
          expect(
            ...
            isEmpty,
            reason:
                'High intensity MMA for 7-year-old must return zero matches due to safety ceiling',
          );
          ...
          expect(
            ...
            isEmpty,
            reason:
                'High intensity Gymnastics for 7-year-old must return zero matches',
          );
          ...
          expect(
            ...
            isEmpty,
            reason:
                'High intensity Rugby for 7-year-old must return zero matches',
          );
        },
      );
    });
